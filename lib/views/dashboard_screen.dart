            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.analytics_rounded, size: 18, color: AppConstants.primaryColor),
                ...
                if (dbService.isLoading &&
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Breakdown Row with FittedBox to prevent truncation
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Expanded(
                  ...
                  // 2x3 FEATURE SQUARE GRID WITH SETTINGS CARD
                  GridView.count(
                    crossAxisCount: 2,
                    shrinkWrap: true,
